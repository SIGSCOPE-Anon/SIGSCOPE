...
2. Major changes to supported queries and libraries are always announced in the [change notes for stable releases](../../SIGSCOPE/Front-end%20Code%20Analysis/change-notes/).
...
3. **Write unit tests**
   ...
   - See [C/C++ CodeQL tests](/Front-end%20Code%20Analysis/cpp/ql/test/README.md) for more information about contributing tests for C/C++ queries in particular.
